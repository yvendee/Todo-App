...
export class TodoItemDto implements ITodoItemDto {
  ...
  priority?: number;
  note?: string | undefined;
  backgroundColor?: string; // Add this property
  ...
  init(_data?: any) {
    if (_data) {
      ...
      this.priority = _data["priority"];
      this.note = _data["note"];
      this.backgroundColor = _data["backgroundColor"]; // Initialize the 'backgroundColor' property
    }
  }
  ...
  toJSON(data?: any) {
    ...
    data["priority"] = this.priority;
    data["note"] = this.note;
    data["backgroundColor"] = this.backgroundColor; // Include 'backgroundColor' in the JSON
    return data;
  }
}
